...
- Name: merkliste.spec.ts >> Merkliste (Cart) Flow >> should add a product to the Merkliste and redirect to contact form with correct body
- Location: e2e\merkliste.spec.ts:4:7
...
Locator: getByRole('button', { name: /Merkliste/i }).first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 15000ms
  - waiting for getByRole('button', { name: /Merkliste/i }).first()
