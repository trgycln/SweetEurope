// Add "Dilim Pastalar" as subcategory under "Pastalar & Kekler"
...
async function main() {
  console.log('🍰 Adding "Dilim Pastalar" subcategory...\n');
  ...
  // "Dilim Pastalar" zaten var mı kontrol et
  ...
  if (existing) {
    console.log(`⏭️  "Dilim Pastalar" already exists (ID: ${existing.id})`);
  ...
  console.log('✅ Successfully created "Dilim Pastalar"!');
