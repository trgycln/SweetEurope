// Add "Mono Pastalar" as subcategory under "Pastalar & Kekler"
...
async function main() {
  console.log('🍰 Adding "Mono Pastalar" subcategory...\n');
  ...
  // "Mono Pastalar" zaten var mı kontrol et
  ...
  if (existing) {
    console.log(`⏭️  "Mono Pastalar" already exists (ID: ${existing.id})`);
  ...
  console.log('✅ Successfully created "Mono Pastalar"!');
