...
export default async function SatislarListPage({ params }: { params: { locale: Locale } }) {
  ...
  const { data: satislar, error } = await (supabase as any)
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href={`/${locale}/portal/finans/satislar/yeni`} className="px-4 py-2 rounded bg-accent text-white font-semibold hover:bg-accent/90">Yeni Satış / Ön Fatura</Link>
      </div>
