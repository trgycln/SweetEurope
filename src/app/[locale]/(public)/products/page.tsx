...
export default async function PublicUrunlerPage({ 
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Elegant Hero Section - Header ile uyumlu */}
            <div className="relative bg-gradient-to-br from-primary via-primary/95 to-primary/90 border-b border-primary/20">
                ...
                <div className="container mx-auto px-4 sm:px-8 py-16 relative z-10">
                    <div className="max-w-3xl">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="p-2.5 bg-accent/20 backdrop-blur-sm rounded-lg border border-accent/30">
                        ...
                        <p className="text-secondary/90 text-lg leading-relaxed">
                            {pageContent.subtitle || 'Entdecken Sie unsere exquisite Auswahl an Premium-Produkten'}
                        </p>
                        ...
                        <div className="mt-8 flex items-center gap-6">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-secondary/80 text-sm font-medium">{urunler.length} Produkte</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="w-1.5 h-1.5 rounded-full bg-accent"></div>
                                <span className="text-secondary/80 text-sm font-medium">{kategoriler.filter(k => !k.ust_kategori_id).length} Kategorien</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container mx-auto px-4 sm:px-8 py-8">
                ...
                <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
                    <nav className="flex items-center gap-2 text-sm">
                        <Link href={`/${locale}`} className="text-gray-500 hover:text-primary transition-colors font-medium">
                            Home
                        </Link>
                        <span className="text-gray-300">/</span>
                        <Link href={`/${locale}/products`} className="text-gray-500 hover:text-primary transition-colors font-medium">
                            {pageContent.title}
                        </Link>
                        {seciliKategoriSlug && (
                            <>
                    ...
                    <aside className="lg:col-span-1">
                        <div className="sticky top-24 space-y-6">
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                                <div className="bg-primary/5 border-b border-gray-100 p-4">
