...
export type Urun = Pick<Tables<'urunler'>, 'id' | 'ad' | 'slug' | 'ana_resim_url' | 'galeri_resim_urls' | 'kategori_id' | 'teknik_ozellikler' | 'urun_gami' | 'koli_ici_kutu_adet' | 'birim_agirlik_kg'> & {
