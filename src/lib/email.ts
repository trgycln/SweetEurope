...
export async function sendPortalWelcomeEmail({
  ...
  const targetName = recipientName || firmName || (isTurkish ? 'Değerli Müşterimiz' : 'Sehr geehrte Damen und Herren');
  const targetLink = actionLink || loginUrl;

  const subject = isTurkish
    ? 'ElysonSweets B2B Müşteri Portalı Giriş Bilgileriniz'
    : 'Ihr Zugang zum ElysonSweets B2B Portal ist freigeschaltet';
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f8fafc; padding: 40px 15px; color: #1e293b; margin: 0;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.01); border: 1px solid #e2e8f0;">
    ...
    <div style="background-color: #0f172a; padding: 36px 30px; text-align: center; border-bottom: 3px solid #16a34a;">
      <h1 style="color: #ffffff; margin: 0; font-size: 26px; font-weight: 800; letter-spacing: 2px;">ELYSON SWEETS</h1>
    ...
    <div style="padding: 36px 32px;">
      <h2 style="margin: 0 0 16px; color: #0f172a; font-size: 20px; font-weight: 700;">Merhaba ${targetName},</h2>
      
      <p style="font-size: 15px; line-height: 1.6; color: #475569; margin: 0 0 24px;">
        ElysonSweets B2B Müşteri Portalı hesabınız başarıyla oluşturulmuştur. Artık size özel fiyatlarla sipariş verebilir, carilerinizi ve sipariş geçmişinizi kolayca takip edebilirsiniz.
      </p>
      ...
      <div style="background-color: #f8fafc; border: 1px solid #cbd5e1; border-radius: 12px; padding: 20px; margin-bottom: 28px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
          <tr>
            <td style="padding: 6px 0; color: #64748b; font-weight: 600; width: 140px;">Kullanıcı E-posta:</td>
    ...
    <div style="background-color: #f1f5f9; padding: 24px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
      ...
      <p style="font-size: 11px; color: #94a3b8; margin: 0;">
        © ElysonSweets Germany • <a href="https://elysonsweets.de" style="color: #94a3b8; text-decoration: none;">elysonsweets.de</a>
      </p>
    </div>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f8fafc; padding: 40px 15px; color: #1e293b; margin: 0;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.01); border: 1px solid #e2e8f0;">
    ...
    <!-- Content -->
    <div style="padding: 36px 32px;">
      <h2 style="margin: 0 0 16px; color: #0f172a; font-size: 20px; font-weight: 700;">Guten Tag ${targetName},</h2>
      
      <p style="font-size: 15px; line-height: 1.6; color: #475569; margin: 0 0 24px;">
        Ihr offizieller Zugang zum ElysonSweets B2B-Kundenportal wurde erfolgreich eingerichtet. Sie können sich ab sofort einloggen, Ihre individuellen B2B-Konditionen einsehen und Bestellungen direkt online aufgeben.
      </p>

      <!-- Credentials Card -->
      <div style="background-color: #f8fafc; border: 1px solid #cbd5e1; border-radius: 12px; padding: 20px; margin-bottom: 28px;">
        <h3 style="margin: 0 0 14px; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; color: #334155; font-weight: 700;">Ihre Zugangsdaten</h3>
        
        <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
          <tr>
            <td style="padding: 6px 0; color: #64748b; font-weight: 600; width: 140px;">Benutzername / E-Mail:</td>
            <td style="padding: 6px 0; color: #0f172a; font-weight: 700; font-family: monospace;">${to}</td>
          </tr>
          ${tempPassword ? `
          <tr>
            <td style="padding: 6px 0; color: #64748b; font-weight: 600;">Passwort:</td>
            <td style="padding: 6px 0; color: #16a34a; font-weight: 700; font-family: monospace; font-size: 15px;">${tempPassword}</td>
          </tr>
          ` : ''}
          <tr>
      ...
      <!-- Features list -->
      <div style="border-top: 1px solid #e2e8f0; padding-top: 24px; margin-top: 24px;">
        <p style="font-size: 13px; font-weight: 700; color: #334155; margin: 0 0 10px;">Ihre Vorteile im B2B-Portal:</p>
        <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #64748b; line-height: 1.8;">
          <li>Individuelle Firmenpreise & Konditionen</li>
          <li>Bequeme 24/7 Online-Bestellungen</li>
          <li>Echtzeit-Sendungsverfolgung, Rechnungen & Lieferscheine</li>
        </ul>
      </div>
    </div>
    ...
    <div style="background-color: #f1f5f9; padding: 24px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
      <p style="font-size: 12px; color: #64748b; margin: 0 0 8px;">
        Bei Fragen stehen wir Ihnen gerne unter <a href="mailto:info@elysonsweets.de" style="color: #0f172a; font-weight: 600; text-decoration: underline;">info@elysonsweets.de</a> zur Verfügung.
      </p>
      <p style="font-size: 11px; color: #94a3b8; margin: 0;">
        © ElysonSweets Germany • <a href="https://elysonsweets.de" style="color: #94a3b8; text-decoration: none;">elysonsweets.de</a>
      </p>
