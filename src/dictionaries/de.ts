...
export const dictionary = {
  ...
  portal: {
    ...
    sidebar: {
      ...
      requests: "Anfragen",
      reports: "Vertriebsberichte",
      materials: "Materialien",
      customers: "Kundenportfolio",
      tasks: "Aufgaben & Follow-ups",
      stock: "Bestandsstatus",
      finance: "Finanzen & Debitoren",
    },
    header: {
      titleSuffix: "Portal",
      logout: "Abmelden",
...
statusOptions: {
  ...
  testimonials: {
    ...
    review1: 'Die FO-Sirupe haben unsere Barkarte auf ein neues Level gebracht. Karamell, Haselnuss und die saisonalen Specials laufen bei uns täglich – konstante Qualität, die sich wirklich verkauft.',
    name1: 'Marco R.',
    company1: 'Inhaber, Café & Bar Köln',
    review2: 'Zuverlässige Mengen, pünktliche Lieferung – genau das, was ein Hotel mit großem Frühstücks- und Barbetrieb braucht. Kein einziger Engpass in über einem Jahr.',
    name2: 'Susanne M.',
    company2: 'F&B Managerin, Boutique-Hotel Köln',
    review3: 'Die Tiefkühl-Dessertbasen sparen uns täglich Stunden an Vorbereitung, ohne Kompromisse bei der Qualität. Unsere Gäste bemerken keinen Unterschied zur Eigenproduktion.',
    name3: 'Thomas K.',
    company3: 'Küchenchef, Restaurant & Eventlocation',
    verifiedBadge: 'Verifizierter Geschäftskunde',
  },
  cta: {
  ...
  footer: {
    ...
    b2bNotice: 'Verkauf ausschließlich an Gewerbetreibende gem. §14 BGB. Alle Preise verstehen sich netto, zzgl. gesetzlicher MwSt., zzgl. Versand.',
    description: 'Ihr B2B-Partner für FO-Markensortiment – Premium-Sirupe, Soßen und Backzutaten für Cafés, Hotels und Patisserien.',
    location: 'Köln, Deutschland',
    sortimentTitle: 'Sortiment',
    catHorecaLabel: 'HoReCa – Gesamtsortiment',
    catSyrupsLabel: 'Sirupe & Barista-Basen',
    catSaucesLabel: 'Saucen & Fruchtpürees',
    catDrinksLabel: 'Getränkepulver & Frappés',
    catIceCreamLabel: 'Eisdiele & Gelateria',
    ...
    linkAgb: 'AGB (B2B)',
    linkWiderruf: 'Widerrufsbelehrung',
    b2bLegalNote: 'Widerrufsbelehrung: Für Käufe durch Gewerbetreibende i.S.v. §14 BGB gelten abweichende Regelungen.',
    badgePrepayment: 'Vorkasse',
    badgeInvoice: 'Rechnung 5 Tage netto',
  ...
  qualityPromise: {
    ...
    item4: { title: 'Volumenrabatte ab Palette', description: 'Transparente Palettenpreise mit klarem Stückpreis-Vergleich. Kein verstecktes Pricing.' },
  },
  certifications: {
    ...
    item3: { label: 'HACCP-konform', description: 'Gefahrenanalyse und kritische Kontrollpunkte nach HACCP-Standard entlang der gesamten Lieferkette.' },
    item4: { label: 'Lückenlose Rückverfolgbarkeit', description: 'Jedes Produkt ist vom Rohstoff bis zur Lieferung vollständig rückverfolgbar.' },
    item5: { label: 'EU-konforme Etikettierung', description: 'Alle Etiketten und Produktspezifikationen entsprechen EU-Lebensmittelverordnungen.' },
  },
  datenschutzPage: {
    title: 'Datenschutzerklärung',
    subtitle: 'Datenschutzerklärung gemäß DSGVO',
    section1Title: '1. Verantwortliche Stelle für die Datenverarbeitung',
    section1Intro: 'Verantwortlicher im Sinne der Datenschutzgrundverordnung (DSGVO) ist:',
    companyRepLabel: 'Vertreten durch den Geschäftsführer:',
    section2Title: '2. Erhebung und Speicherung von Kundendaten (Lead Generation)',
    section2Text: 'Wenn Sie über unser Kontaktformular oder per E-Mail (z.B. für Großhandelsanfragen, Musteranforderung) Kontakt mit uns aufnehmen, erheben wir folgende Daten: Firmenname, Ansprechpartner, E-Mail-Adresse, Telefonnummer sowie ggf. Ihre Umsatzsteuer-ID. Die Verarbeitung dieser Daten erfolgt ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO (Durchführung vorvertraglicher Maßnahmen und Vertragserfüllung im B2B-Bereich).',
    section3Title: '3. Cookies und Tracking für B2B-Marketing',
    section3Text: 'Diese Website verwendet Cookies und Tracking-Technologien (z.B. Google Analytics, Meta Pixel) zur Analyse und für B2B-Marketing. Diese Skripte werden nur aktiviert, wenn Sie im Cookie-Banner ausdrücklich Ihre Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) erteilt haben.',
    lastUpdated: 'Stand: Mai 2026 · Elyson Sweets GmbH i.G., Köln · info@elysonsweets.de',
  },
  impressumPage: {
    title: 'Impressum',
    legalNote: 'Angaben gemäß § 5 TMG',
    managingDirectorLabel: 'Vertreten durch den Geschäftsführer',
    contactLabel: 'Kontakt',
    registerLabel: 'Registereintrag',
    registerPending: 'Die Eintragung in das Handelsregister ist angemeldet und befindet sich in Bearbeitung.',
    registerCourt: 'Registergericht: Amtsgericht Köln',
    registerNumberPending: 'Registernummer: wird nachgetragen',
    vatLabel: 'Umsatzsteuer-ID',
    vatText: 'Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:',
    vatPending: 'Beantragt und wird nachgetragen.',
    disputeLabel: 'Streitschlichtung',
    disputeText: 'Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen, da sich unser Angebot ausschließlich an Unternehmer (B2B) richtet.',
    lastUpdated: 'Stand: Mai 2026 · Elyson Sweets GmbH i.G., Köln · info@elysonsweets.de',
  },
  agbPage: {
    title: 'AGB (B2B)',
    subtitle: 'Allgemeine Geschäftsbedingungen der Elyson Sweets GmbH i.G.',
    para1Title: '§ 1 Geltungsbereich (Ausschließlich B2B)',
    para1p1: '(1) Diese AGB gelten für alle Verträge, Lieferungen und sonstigen Leistungen der Elyson Sweets GmbH i.G.',
    para1p2: '(2) Unser Angebot richtet sich ausschließlich an Unternehmer im Sinne des § 14 BGB, juristische Personen des öffentlichen Rechts oder öffentlich-rechtliche Sondervermögen. Ein Verkauf an Verbraucher (§ 13 BGB) ist ausgeschlossen. Das gesetzliche Widerrufsrecht für Verbraucher findet daher keine Anwendung.',
    para2Title: '§ 2 Preise und Zahlungsbedingungen',
    para2p1: '(1) Alle auf der Website angegebenen Preise sind Nettopreise zuzüglich der gesetzlichen Mehrwertsteuer.',
    para2p2: '(2) Versandkosten werden separat berechnet. Der Kaufpreis ist sofort nach Rechnungsstellung fällig.',
    para3Title: '§ 3 Eigentumsvorbehalt',
    para3text: 'Die gelieferte Ware bleibt bis zur vollständigen Bezahlung sämtlicher Forderungen aus der Geschäftsverbindung das Eigentum der Elyson Sweets GmbH i.G.',
    para4Title: '§ 4 Untersuchungs- und Rügepflicht (§ 377 HGB)',
    para4p1: '(1) Der Käufer ist verpflichtet, die gelieferte Ware unverzüglich nach Erhalt zu prüfen.',
    para4p2: '(2) Offensichtliche Mängel, Transportschäden oder Fehlmengen müssen der Elyson Sweets GmbH i.G. spätestens innerhalb von 48 Stunden nach Lieferung schriftlich mitgeteilt werden. Erfolgt keine rechtzeitige Rüge, gilt die Ware als genehmigt.',
    para5Title: '§ 5 Erfüllungsort und Gerichtsstand',
    para5p1: '(1) Erfüllungsort für Lieferung und Zahlung ist der Sitz der Elyson Sweets GmbH i.G. (Köln).',
    para5p2: '(2) Gerichtsstand für alle Streitigkeiten ist das für den Sitz der Gesellschaft zuständige Gericht in Köln. Es gilt das Recht der Bundesrepublik Deutschland.',
    lastUpdated: 'Stand: Mai 2026 · Elyson Sweets GmbH i.G., Köln · info@elysonsweets.de',
  },
  contactPage: {
  ...
  seo: {
    home: {
      ...
      description: "ElysonSweets – Ihr B2B-Großhändler für FO Food Products in Deutschland. Über 400 Premium-Sirupe, Saucen, Dessertbasen & Barista-Zutaten. Halal & BRC-zertifiziert."
    },
    products: {
  ...
  publicProductsPage: {
    b2bCatalogLabel: 'B2B Großhandels-Katalog',
    heroTitle: 'Sortiment für Profi-Küchen & Gastronomie',
    heroDescription: 'Tiefkühl-Desserts, Sirupe, Kaffee und Backzutaten – direkt für Cafés, Hotels und Patisserien.',
    totalProductsInCatalog: 'Artikel im Sortiment',
    ...
    guestBannerPrefix: 'Für Preise und Bestellungen',
    guestBannerSuffix: 'bitte im Partnerportal anmelden.',
    loginNow: 'Jetzt anmelden →',
    searchPlaceholder: 'Produkt, Art.-Nr. oder EAN suchen…',
    gridTitle: 'Gitteransicht',
    listTitle: 'Listenansicht',
    features: 'Merkmale:',
    flavor: 'Aroma:',
    elysonRecommends: 'ElysonSweets empfiehlt',
    personallySelected: '– persönlich ausgewählt',
    available: 'Verfügbar',
    onRequest: 'Auf Anfrage',
    priceOnRequest: 'Preis auf Anfrage',
    priceLogin: 'Preis für Partner',
    details: 'Details',
    cartAdded: '✓ Gemerkt',
    cartAdd: '＋ Merkliste',
    piecesPerCarton: 'Stk./Ktn.',
    cartonsPerPallet: 'Ktn./Pal.',
    searchPlaceholderGrid: 'Produkt, Art.-Nr. oder EAN suchen…',
    guestBannerText: 'Für Preise und Bestellungen bitte im Partnerportal anmelden.'
  }
,
  foProductDetail: {
      "category": "Kategorie",
      ...
      "allergenTraces": "Kann Spuren enthalten von:",
