...
statusOptions: {
  ...
  datenschutzPage: {
    ...
    lastUpdated: 'Stand: Mai 2026 · Elyson Sweets GmbH, Köln · info@elysonsweets.de',
  },
  impressumPage: {
    title: 'Impressum',
  ...
  agbPage: {
    title: 'AGB (B2B)',
    subtitle: 'Allgemeine Geschäftsbedingungen der Elyson Sweets GmbH',
    para1Title: '§ 1 Geltungsbereich (Ausschließlich B2B)',
    para1p1: '(1) Diese AGB gelten für alle Verträge, Lieferungen und sonstigen Leistungen der Elyson Sweets GmbH',
    ...
    para3text: 'Die gelieferte Ware bleibt bis zur vollständigen Bezahlung sämtlicher Forderungen aus der Geschäftsverbindung das Eigentum der Elyson Sweets GmbH',
    ...
    para4p2: '(2) Offensichtliche Mängel, Transportschäden oder Fehlmengen müssen der Elyson Sweets GmbH spätestens innerhalb von 48 Stunden nach Lieferung schriftlich mitgeteilt werden. Erfolgt keine rechtzeitige Rüge, gilt die Ware als genehmigt.',
    para5Title: '§ 5 Erfüllungsort und Gerichtsstand',
    para5p1: '(1) Erfüllungsort für Lieferung und Zahlung ist der Sitz der Elyson Sweets GmbH (Köln).',
