...
statusOptions: {
  ...
  isletmeBilgileri: {
    ...
    satisFirsati: 'Verkaufschance',
    buyumeFirsati: 'Wachstumschance',
    satisStratejisi: 'Verkaufsstrategie / Einstiegspunkt',
    satisStratejisiPh: 'Wie wird dieser Betrieb erschlossen? Stärken, Schwächen...',
    tahminiAylikPotansiyel: 'Geschätztes Monatspotenzial (€)',
    tahminiAylikPotansiyelPh: 'z. B. 500',
    crosssellFirsati: 'Cross-Sell-Chance',
    crosssellFirsatiPh: 'Welche Produktgruppen könnten ergänzt werden?',
    churnRiski: 'Abwanderungsrisiko',
    churnNeden: 'Grund des Abwanderungsrisikos',
    churnNedenPh: 'Warum besteht ein Abwanderungsrisiko?',
    potansiyel: 'Potenzial',
    kategoriA: 'A - VOLUMEN-KUNDE | Hotel, Catering, Kettencafé (80–100 Punkte)',
    kategoriB: 'B - AKTIVER KUNDE | Café, Konditorei, Eisdiele (50–79 Punkte)',
    kategoriC: 'C - WACHSENDER KUNDE | Klein, aber mit Potenzial (20–49 Punkte)',
